...
export const KNOW_YOUR_DIGITAL_STATUS = "Know Your Digital Status";
...
export const KNOWLEDGE_CENTER = [
  ...
  {
    heading:
      "How to scale-up your business with a collateral-free business loan?",
...
export const VYAPAR = {
  title: "Vyapar",
  subTitle: [
    "Get free access to our Vyapar android mobile app.",
    "Enjoy 1 Month Free Trial Vyapar Business Accounting Desktop App to enhance your business.",
  ],
  description: [
    "Free GST Billing Software & App for Small Businesses",
...
export const HYLO_BIZ = {
  ...
  description: [
    <>
      <p>{"Hylobiz is a Powerful & Simplified tool to:"}</p>
...
export const MSWIPE = {
  ...
  availNowResponseText:
    "Thank you for your interest. An executive from Mswipe will reach out to you shortly.",
};
