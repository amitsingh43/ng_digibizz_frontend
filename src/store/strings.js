...
export const TERMS_AND_CONDITIONS_DETAILED =
	'This Agreement sets forth the terms and conditions that apply to the access and use of the Website "<Link>" and its Mobile Application (collectively be referred to as "Website"), which is managed and operated by NeoGrowth Credit Private Limited, (hereinafter collectively be referred to as "Company"/ "NeoGrowth"), incorporated under the laws of India and registered under the Companies Act, 1956.This document/agreement (referred to as “Agreement”) is an electronic record in terms of Information Technology Act, 2000 and generated by a computer system and does not require any physical or digital signatures. This document is published in accordance with the provisions of Rule 3 of the Information Technology (Intermediaries guidelines) 2011, that provides for the due diligence to be exercised for the access or usage of this Website.';
