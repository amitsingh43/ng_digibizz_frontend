...
import SmarttechOne from '../assets/partners/carousel/Smarttech/one.jpg';

import SyrowOne from '../assets/partners/carousel/Syrow/one.jpg';

import TerragoOne from '../assets/partners/carousel/Terrago/one.jpg';
import TerragoTwo from '../assets/partners/carousel/Terrago/two.jpg';

import TOTone from '../assets/partners/carousel/TOT/one.jpg';
...
export const TELL_ABOUT_YOU_DESC = 'We require some basic information from you before you begin your survey.';
...
export const KNOWLEDGE_CENTER = [
	{
		...
		desc: 'Here are a few tips to help you secure business and prevent cyber frauds.',
		image: one,
		bg: one_bg,
		id: 1,
		badge: knowledge_1,
		sections: [
			...
			},
			{
				...
				heading: null,
				content:
					"There are many cases when a customer's account gets hacked, and businesses are caught between the credit card company and the customer. You can avoid such situations by using software that detects suspicious activity.",
			},
			{
				type: 'content',
				list: null,
			...
			},
			{
				...
				content:
					'You have put up a strong firewall and enabled powerful antivirus. However, cybercriminals are always one step ahead. There are new forms of threat and new viruses/malware that pop up regularly. ',
			},
			{
				type: 'content',
				list: null,
			...
			},
			{
				...
				heading: null,
				content:
					'The only way to prevent cyber fraud is to stay hyper-vigilant. Make sure you follow all the tips given above. In addition to this, there are many insurance companies that offer insurance against cyber fraud for businesses. You can consider taking such insurance as an added protection.',
			},
		],
	},
	{
		heading: ' What is UPI and benefits of using UPI',
		desc: 'What is UPI, and how does it work? Why should you choose UPI over other modes of money transfer? Let us find out.',
		image: two,
		bg: two_bg,
		id: 2,
		badge: knowledge_2,
	...
	{
		heading: 'How to list yourself on online delivery platforms, manage table bookings and orders?',
		desc: 'Within a few simple steps, you can submit your application to get listed and start accepting orders.  ',
		image: three,
		bg: three_bg,
		id: 3,
		badge: knowledge_3,
		sections: [
			...
			},
			{
				...
				heading: null,
				content:
					'In case of any issues, Zomato Order and Zomato Book provide you with customer support giving you immediate access to help with any order related issues. This way, you are always sure to be running smoothly with 24/7 support executives available to sort out any hiccups.',
			},
		],
	},
	{
		heading: 'How to get discovered online?',
		desc: 'How to list yourself on online delivery platforms, manage table bookings and orders?',
		image: four,
		id: 4,
		badge: knowledge_4,
		bg: four_bg,
	...
	},
	{
		...
		sections: [
			...
			{
				type: 'content',
				list: ['Name of your restaurant', 'Your Designation', 'Pin code', 'State', 'Contact Number'],
			...
			},
			{
				...
				content: 'Hit the Yes button to submit additional information and proceed with your application.',
			},
			{
				type: 'content',
				list: [
				...
				heading: 'Step 4 – Fill in relevant details in the form and upload documents.',
				content: 'You must have the following information ready at the time of form filling -',
			},
			{
				type: 'content',
			...
			{
				type: 'content',
				list: ['Cancelled cheque or passbook', 'Take away bill', 'A picture of your menu'],
				heading: 'Step 5 – Get the hard copies and originals of the following documents.',
				content: null,
			},
			{
				type: 'content',
			...
			},
			{
				type: 'content',
				list: null,
				heading: 'Step 1 – Select the “Add a restaurant” option on zomato.com at the bottom of the page.',
				content:
					'The Zomato partner with us option will redirect you to the page of getting started with registering your food outlet.',
			},
			{
				type: 'content',
				list: ['Restaurant name', 'Your credentials', 'City', 'Opening status', 'Contact Number'],
				heading: 'Step 2 – Enter and submit your information.',
				content: 'You will get prompted to fill out the following after hitting the partner with us Zomato ',
			},
			{
				type: 'content',
				list: null,
			...
			},
			{
				...
				list: null,
				content:
					'Once you submit your listing, the verification process of your outlet will begin. After successful validation, your page will go live, and you become a delivery partner of Zomato.',
			},
			{
				type: 'content',
				heading: 'Step 5: A Zomato Sales Representative might contact you to cross-check the details.',
				list: ['Shop License', 'GST number', 'FSSAI License', 'PAN details'],
				content: 'Keep the soft and hard copies of the following documents available -',
			},
			{
				type: 'content',
				heading: null,
	...
	},
	{
		...
		desc: 'As the era of digitisation is taking over the world, it is imperative that you learn how to set up your own online shop.',
		image: six,
		id: 6,
		badge: knowledge_6,
		bg: six_bg,
		sections: [
			...
			},
			{
				...
				type: 'content',
				list: ['Your sales figures', 'Efforts used in customer support', 'Customer retention rate'],
			},
			{
				content:
			...
			},
			{
				...
				heading: null,
				content: 'On top of the form, enter the company/business name and hit the Continue button. ',
			},
			{
				type: 'content',
				list: null,
	...
	},
	{
		...
		desc: 'The procedure to register a company can be extremely simple and convenient to follow.',
		image: seven,
		id: 7,
		badge: knowledge_7,
		bg: seven_bg,
		sections: [
			...
			},
			{
				...
				list: null,
				content: 'As per the Information Act 2000, a valid digital signature on all the documents is required.',
				type: 'content',
			},
			{
				type: 'content',
			...
			},
			{
				...
				list: null,
				heading: null,
				content: 'Under FSSAI, the license or registration is divided into three categories, namely:',
			},
			{
				type: 'content',
				list: null,
				heading: '7. Gumastha license',
				content: 'This is for businesses that need to be established in the state of Maharashtra.',
			},
			{
				type: 'content',
				list: null,
			...
			{
				type: 'content',
				list: ['Manufacturing: Class 1 to 34', 'Trading: Class 35', 'Services: Class 35 to 45'],
			...
			},
			{
				...
				list: null,
				heading: null,
				content: 'Step 6 – Trademark should be renewed every 10 years to use it for an indefinite period.',
			},
			{
				type: 'content',
				list: null,
			...
			},
			{
				...
				list: null,
				heading: null,
				content: '		2.		Service Tax to be levied on the customer services provided by an entity',
			},
			{
				type: 'content',
				list: null,
				heading: null,
				content: '		3.		Value Added Tax is a commercial tax levied at all the stages of the supply chain.',
			},
			{
				type: 'content',
				list: null,
				heading: null,
				content: '		4.		Customs Duty and Octroi Tax if goods are imported/exported from/to another country.',
			},
			{
				type: 'content',
				list: null,
				heading: null,
				content: '		5.		Excise Duty which is levied on all the goods manufactured or produced in India',
			},
			{
				type: 'content',
				list: null,
	...
	},
	{
		...
		desc: 'This article will discuss the top 5 government loan schemes that can aid your business to reach greater heights.',
		image: eight,
		id: 8,
		badge: knowledge_8,
		bg: eight_bg,
		sections: [
			...
			},
			{
				...
				heading: '5. Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE) ',
				content:
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				content: 'There are a few proven techniques to clear bad credit history. They are:',
				type: 'content',
				list: [
			...
			},
			{
				...
				content: 'The following steps will guide you on how to improve credit score in 30 days.',
			},
			{
				type: 'content',
				list: [
				...
				content: 'The following steps will guide you on how to raise credit score by 200 points.',
			},
			{
				type: 'content',
				list: [
	...
	{
		heading: 'How to scale-up your business with a collateral-free business loan?',
		desc: 'Plan exactly how you’ll use your loan amount and how you’ll pay it off.',
		image: ten,
		id: 10,
		badge: knowledge_10,
		bg: ten_bg,
		sections: [
			{
				...
				heading: null,
				content:
					'Whether your business is a startup or if you’re ready for expansion, you need funds to power your small business. But before you seek a loan, you need to plan about exactly how you’ll use your loan amount and how you’ll pay it off. So, that you don’t fall into a situation where you can’t pay off an unsecured business loan. Without a strategy on how to put the money to work, you’ll take up a loan that might become a burden on your shoulders.',
			},
			{
				type: 'content',
				list: null,
				heading: 'Read on to know how an unsecured business loan can scale up your business: ',
				content: null,
			},
			{
				type: 'content',
			...
			},
			{
				...
				list: [
					...
					// },
					{
						...
						content: 'DiGibizz helps small businesses by providing small business loans to deserving SMEs.',
					},
					{
		...
		blog: [
			...
			},
			{
				...
				list: [
					...
					{
						bullet: 'Customers prefer to shop remotely because of the pandemic - ',
						content: 'Customers prefer to shop online because of the fear of infection from COVID-19.',
					},
					{
			...
			},
			{
				...
				list: [
					...
					},
					{
						bullet: 'More effective signage - ',
						content:
							'DiGibizz was able to suggest LED signboards and more prominent banners to help get more attention from potential visitors.',
					},
					{
					...
					// },
					{
						...
						content:
							'Finally, diGibizz helped N.S. Stores solve their problems by creating an online store that would allow them to receive and fulfil orders online. This enabled them to perform business operations without the need for customers to be physically present.',
					},
				],
			},
			{
...
export const NEAR_STORE = {
	title: 'Near.Store',
	subTitle: ['Free Near.Store Lite / Dhandabook App ', 'Store Digitalization Dongle - INR 2400 + GST'],
	description: [
...
export const MAGICPIN = {
	...
	description: ['Platform where users and merchants in a locality discover, interact, and transact.'],
	image: magic_pin,
	backgroundColor: '#fff',
	url: '',
	stars: null,
...
export const MYBILLBOOK = {
	title: 'My BillBook',
	subTitle: ['myBillBook Annual Plan (android & web application) - INR 799 for 12 months & additional 3 months free'],
	description: [
...
export const PINNACLE = {
	...
	description: [
		...
		'Pinnacle believes in transforming your business with Creativity & Diversity. Their services include creation of Business Display Material, Offline & Online Business promotions, Procurement of Business Set-up IT Systems & others.',
	],
	image: pinnacle,
	backgroundColor: '#fff',
...
export const RAZORPAY = {
	...
	description: ['All in One- Payment gateway that supports netbanking, credit, debit Cards, UPI etc.'],
	image: razorpay,
	backgroundColor: '#fff',
	url: '',
};
...
export const VAKIL_SEARCH = {
	title: 'VakilSearch',
	subTitle: ['Avail Free GST Registration by taking GST Filings at Rs.2999 onwards', 'ITR Filings at Rs.499 onwards'],
	description: [
		'Vakilsearch is a technology powered platform for all legal, compliance and accounting needs.',
		"VakilSearch is India's largest platform, with a dominant market share of 10% in setting up new businesses and 4% in trademark applications. More than 5 lakh clients rely on us for their compliance management, accounting and legal needs",
	],
	image: vakilsearch,
	backgroundColor: '#fff',
...
export const BRANDPULSE = {
	...
	description: [
		...
		'Brandppulse offers you Digital Display solution which will help you earn money from advertisement displayed in your business premises. Our free to use content management system for display advertisement will digitally transform your business and also add revenue to it.',
	],
	image: brandpulse,
	backgroundColor: '#fff',
...
export const PAGARBOOK = {
	title: 'PagarBook',
	subTitle: [
		'PagarBook Premium App - INR 999',
		'PagarBook Premium Desktop - INR 1899',
		'PagarBook Biometric - 20% Off.',
	],
	description: [
...
export const EASY_FILE_ITR = {
	...
	description: [
		'24/7 Phone, Email & Chat Support.',
		'Easy File ITR offers accounting / GST / TDS/ Income Tax and auditing services across PAN India for all individuals and small to medium-sized businesses, corporates and assist finance and accounting professionals to reduce their workloads.',
	],
...
export const HYLO_BIZ = {
	...
	description: [
		...
		'2. Fast track your way to invoice collections',
		'3. Auto-reconciliations of receivables',
...
export const NEOCASH_INSTA = {
	title: 'NeoCash Insta',
	subTitle: ['Get your ₹ 1 lakh collateral free business loan approved in 2 minutes with daily repayment of ₹ 250.'],
	image: neocash_insta,
	description: [
...
export const THE_ONLINE_TEAM_4 = {
	...
	description: [
		...
		'With TOT, capture your product with quality. A product picture is the first impression of  your product and surely you would want it to be the best one. ',
	],
	image: the_online_team,
	backgroundColor: '#fff',
...
export const URBAN_CFO = {
	...
	description: [
		...
		'URBANCFO offers custom tailor-made packages for Individuals & Businesses starting from Rs. 2499/- per month to help them to be compliant with Laws & Regulations ranging from personal income tax return filing to new business incorporation to getting all regulatory registrations/licenses to Accounting and timely filing of GST MCA TDS & other returns. It helps you to stay focused on your core business.',
	],
	image: urban_cfo,
	backgroundColor: '#fff',
...
export const PARTNERS = [
	{
		...
		data: [MOBICOMMERCE1, NEAR_STORE, ACCUNITY_SERVICES1, SNAPBIZZ, THE_ONLINE_TEAM_1],
		tag: 'sell_online',
	},
	// {
