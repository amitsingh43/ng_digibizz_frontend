  ...
  return (
    <div>
      ...
      <div>
        ...
        {partner === "Onsurity" && <div>
          <div className={show[field] ? "active" : "hidden"}>
            <h5>Benefits of Onsurity HealthCare Membership</h5>

            <h5>For Employers</h5>
            <ul>
              <li>Designed for SMEs, sStart-ups, and growing businesses

                Monthly subscription plans – first of its kind in India

                Inclusive for all – Employees (including part-time), freelancers to contractual workforce
              ...
              <li>
                ...
                Team on-boarding journey in just 2 minutes
            ...
            <ul>
              <li>
                ...
                Group healthcare and personal accidental insurance

                Addition of family members in the plan with personal purchase
